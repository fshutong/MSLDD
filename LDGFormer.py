...
class GRN(paddle.nn.Layer):
    def __init__(self, dim):
        super().__init__()
        self.gamma = paddle.create_parameter(shape=[1, dim, 1, 1], dtype=paddle.float32,
                                             default_initializer=paddle.nn.initializer.Constant(value=0.0))
        self.beta = paddle.create_parameter(shape=[1, dim, 1, 1], dtype=paddle.float32,
                                            default_initializer=paddle.nn.initializer.Constant(value=0.0))
...
class LDGFormer(nn.Layer):
    ...
    def __init__(self,
        ...
        self.linear_fuse = layers.GRNConvBNReLU(
